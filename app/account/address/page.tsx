...
export type AccountAddressFormValue = {
    id?: string;
...
const initialAddressValue: AccountAddressFormValue = {
    id: "",
...
function getOptionValue<T extends { id?: number | string; rajaongkir_id?: number | string }>(
    item: T,
) {
    return String(item.rajaongkir_id ?? item.id ?? "");
}
...
export default function AccountAddressPage() {
    ...
    const [formValue, setFormValue] =
        useState<AccountAddressFormValue>(initialAddressValue);
    ...
    const updateFormValue = (partial: Partial<AccountAddressFormValue>) => {
    ...
    const fetchAddresses = async () => {
        ...
        try {
            ...
            if (response.data.length === 0) {
                ...
                setFormValue(initialAddressValue);
                setMode("create");
                return;
            }
    ...
    const handleProvinceChange = async (
        ...
        const province = provinces.find(
            (item) => getOptionValue(item) === provinceId,
        );
    ...
    const handleCityChange = async (
        ...
        const city = cities.find((item) => getOptionValue(item) === cityId);
    ...
    const handleDistrictChange = async (
        ...
        const district = districts.find(
            (item) => getOptionValue(item) === districtId,
        );
    ...
    const handleSubdistrictChange = (
        ...
        const subdistrict = subdistricts.find(
            (item) => getOptionValue(item) === subdistrictId,
        );
                ...
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <p className={`mt-2 text-sm sm:text-base ${theme.colors.neutral.body}`}>
                            Kelola alamat pengiriman untuk proses checkout yang lebih cepat.
                        </p>
                    </div>
                </div>
                ...
                <section className="rounded-3xl bg-white p-6 shadow-sm">
                    <div className="mb-5 flex items-start justify-between gap-4">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                Pilih alamat tersimpan, tambah alamat baru, atau ubah alamat.
                            </p>
                        </div>
                    ...
                    {isLoadingAddresses ? (
                        ...
                        <div className="rounded-2xl border border-red-100 bg-red-50 p-6 text-center">
                            <p className="font-bold text-red-600">Gagal memuat alamat</p>
                            <p className="mt-2 text-sm text-red-500">{errorMessage}</p>

                            <button
                                type="button"
                                onClick={fetchAddresses}
                                className="mt-5 inline-flex items-center justify-center gap-2 rounded-xl bg-pink-500 px-5 py-3 text-sm font-bold text-white hover:bg-pink-600"
                            >
                                <RefreshCcw size={16} />
                                Coba Lagi
                            </button>
                    ...
                    {addresses.length === 0 && mode === "create" ? (
                        <div className="mb-5 rounded-2xl border border-orange-200 bg-orange-50 p-4">
                            ...
                            <p className="mt-1 text-sm text-orange-600">
                                Buat alamat pengiriman terlebih dahulu.
                            </p>
                        </div>
                    ) : null}
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        {provinces.map((province) => (
                                            <option key={province.id} value={getOptionValue(province)}>
                                                {province.name}
                                            </option>
                                        ))}
                                    </select>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        {cities.map((city) => (
                                            <option key={city.id} value={getOptionValue(city)}>
                                                {city.name}
                                            </option>
                                        ))}
                                    </select>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        {districts.map((district) => (
                                            <option key={district.id} value={getOptionValue(district)}>
                                                {district.name}
                                            </option>
                                        ))}
                                    </select>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        {subdistricts.map((subdistrict) => (
                                            <option
                                                key={subdistrict.id}
                                                value={getOptionValue(subdistrict)}
                                            >
                                                {subdistrict.name}
                                            </option>
                                        ))}
